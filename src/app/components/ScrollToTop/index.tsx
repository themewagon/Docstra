  ...
  return (
    <div className="fixed bottom-8 right-8 z-999">
      <div className="flex items-center gap-2.5">
        <Link href={"https://themewagon.com/themes/Docstra/"} target="_blank" className="hidden lg:block bg-primary text-sm hover:bg-blue-700 text-white px-4 py-3.5 leading-none rounded-lg font-medium text-nowrap">
          Download Now
        </Link>
